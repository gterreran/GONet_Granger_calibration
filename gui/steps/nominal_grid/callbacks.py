...
def reset_nominal_parameters(
    ...
    return (
        DEFAULT_PARAMETERS["ring_max_dist"],
        DEFAULT_PARAMETERS["ring_gate_tol_r"],
        DEFAULT_PARAMETERS["min_ring_group"],
        DEFAULT_PARAMETERS["spoke_max_dist"],
        DEFAULT_PARAMETERS["spoke_min_dist"],
        DEFAULT_PARAMETERS["spoke_gate_tol_theta"],
        DEFAULT_PARAMETERS["min_spoke_group"],
    )
